...
public class CheckInService {
    ...
    private void verifyCheckInExist(String attendeeId){
        Optional<CheckIn> isCheckIns = this.checkinRepository.findByAttendeeId(attendeeId);
        if(isCheckIns.isPresent()) throw new CheckInAlreadyExistsException("Attendee already checked in");
    }
